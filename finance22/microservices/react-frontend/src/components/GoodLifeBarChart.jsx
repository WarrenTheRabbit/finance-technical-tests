...
const GoodLifeBarChart = ({ data }) => {
  ...
  return (
    <div style={{ width: isMobile ? "100%" : "400px" }}>
      <ResponsiveContainer width="100%" height={660}> {/* Adjust height as needed */}
        <BarChart 
          layout="vertical" 
          data={formattedData} 
        ...
        >
          ...
          <YAxis
            ...
            width={70} // Adjust width to fit text properly
          />
          <Tooltip />
          <Bar 
            dataKey="amount" 
...
export default GoodLifeBarChart;
